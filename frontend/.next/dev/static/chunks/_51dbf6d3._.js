...
function NewExpensePage() {
    ...
    const [date, setDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(todayISO());
    ...
    const selectedUnit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewExpensePage.useMemo[selectedUnit]": ()=>items.find({
                "NewExpensePage.useMemo[selectedUnit]": (i)=>i.id === itemId
            }["NewExpensePage.useMemo[selectedUnit]"])?.unit || ""
    }["NewExpensePage.useMemo[selectedUnit]"], [
        items,
        itemId
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewExpensePage.useEffect": ()=>{
            ({
                "NewExpensePage.useEffect": async ()=>{
                    setError("");
                    setLoadingCats(true);
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/categories");
    ...
    async function loadItems(catId) {
        ...
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/items?categoryId=${encodeURIComponent(catId)}`);
    ...
    async function onSubmit(e) {
        ...
        setSaving(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/expenses", {
                method: "POST",
                body: JSON.stringify({
                    date,
                    itemId,
...
_s(NewExpensePage, "gdh7olla7weFTfWBRcsBTqrVj14=", false, function() {
    return [
...
//# sourceMappingURL=_51dbf6d3._.js.map
...
function ExpensesPage() {
    ...
    const sum = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ExpensesPage.useMemo[sum]": ()=>rows.reduce({
                "ExpensesPage.useMemo[sum]": (s, r)=>s + (r.total || 0)
            }["ExpensesPage.useMemo[sum]"], 0)
    }["ExpensesPage.useMemo[sum]"], [
        rows
    ]);
...
_s(ExpensesPage, "IpdGlhjWnm7U5bMXqHQBQQKPFVw=", false, function() {
    return [
...
//# sourceMappingURL=_244f8446._.js.map